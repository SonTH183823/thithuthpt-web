...
function SearchSection(props) {
  return (
    <div className={'bg-white w-full'}>
      <div className="container mx-auto padding-mobile grid-cols-2 md:grid hidden">
        ...
        <div className={'flex-1 my-auto px-4'}>
          <div className={'font-bold text-2xl'}>Ngân hàng đề thi trắc nghiệm online, tuyển tập bài giảng, bài học trực
            tuyến.
          </div>
          <FeatureSection/>
        </div>
      </div>
      <div className="container mx-auto padding-mobile md:hidden block">
        <div className={'flex-1 my-auto px-4'}>
          <FeatureSection/>
        </div>
      </div>
